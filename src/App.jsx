      ...
      <div className="screen" id="screen-academic">
        ...
        <div className="screen-scroll has-header">
          ...
          <div className="tab-content active" id="tab-quiz">
            <div className="challenge-card" onClick={() => window.navigate('screen-academic')} style={{cursor: 'pointer'}}>
      ...
      <div className="screen" id="screen-concession">
        ...
        <div className="screen-scroll has-header">
          ...
          <div className="form-card">
            ...
            <button className="btn-primary full-width" onClick={handleTrainSubmit}>Submit Application</button>
          </div>
        ...
        <div className="screen-scroll has-header">
          ...
          <div className="cart-bar">
            <div className="cart-info">
              <span className="cart-count" id="cart-count-view">{cart.length} items</span>
              <span className="cart-price" id="cart-price-view">₹{cartFinal.toFixed(0)}</span>
            </div>
      ...
      <div className="screen" id="screen-canteen-bill">
        ...
        <div className="screen-scroll has-header">
          ...
          <div className="coupon-row">
            <input className="coupon-input" placeholder="Enter coupon code (CAMPUS10)" value={coupon} onChange={(e) => setCoupon(e.target.value)} />
        ...
        <div className="screen-scroll has-header">
          ...
          <div className="form-card">
            ...
            <div className="form-group">
              ...
              <input className="form-input" placeholder="e.g. Blue Water Bottle" value={lostInput} onChange={(e) => setLostInput(e.target.value)} />
            </div>
            <div className="form-group">
              <label className="form-label">Location</label>
              <input className="form-input" placeholder="e.g. Library, 1st Floor" value={lostLocation} onChange={(e) => setLostLocation(e.target.value)} />
            </div>
            <div className="form-group">
            ...
            <button className="btn-primary full-width" onClick={submitLostItem}>Post Item</button>
          </div>
        ...
        <div className="screen-scroll has-header">
          ...
          <div className="form-card">
            ...
            <div className="form-group" style={{marginTop: '16px'}}>
              ...
              <textarea className="form-input" rows="4" placeholder="Describe your experience..." value={feedbackInput} onChange={(e) => setFeedbackInput(e.target.value)}></textarea>
            </div>
            ...
            <button className="btn-primary full-width" onClick={submitFeedback}>Submit Feedback</button>
          </div>
